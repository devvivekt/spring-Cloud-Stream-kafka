...
public class DepartmentAggregate extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 796727387108226049L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DepartmentAggregate\",\"namespace\":\"com.learning.kafkaproduceravro.model\",\"fields\":[{\"name\":\"total_salary\",\"type\":[\"null\",\"int\"]},{\"name\":\"employee_count\",\"type\":[\"null\",\"int\"]},{\"name\":\"avg_salary\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public static com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder newBuilder() {
    return new com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder();
  }
   ...
   * @return A new DepartmentAggregate RecordBuilder
   */
  public static com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder newBuilder(com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder other) {
    return new com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder(other);
  }
   ...
   * @return A new DepartmentAggregate RecordBuilder
   */
  public static com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder newBuilder(com.learning.kafkaproduceravro.model.DepartmentAggregate other) {
    return new com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DepartmentAggregate>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.kafkaproduceravro.model.DepartmentAggregate other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.total_salary)) {
        this.total_salary = data().deepCopy(fields()[0].schema(), other.total_salary);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder setTotalSalary(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder clearTotalSalary() {
      total_salary = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder setEmployeeCount(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder clearEmployeeCount() {
      employee_count = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder setAvgSalary(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkaproduceravro.model.DepartmentAggregate.Builder clearAvgSalary() {
      avg_salary = null;
