...
import com.learning.kafkastreamjoin.bindings.OTPListenerBinding;
...
public class OTPValidationService {
    ...
    /*
    both topics created with same number of partitions, same transactionID as key, same default partitioner
    no need to perform repartitioner
     */
    @StreamListener
